      ...
      >
        ...
        >
          <h1 style={{ textAlign: 'center', color: 'white' }}>
            Privacy Policy for ELK
          </h1>

          <section style={{ color: 'white' }}>
            <h2>Introduction</h2>
            <p>
              Welcome to ELK! We are committed to protecting your privacy and
          ...
          <section style={{ color: 'white' }}>
            ...
            <ul>
              ...
              <li>
                ...
                interactions with our platform, such as search queries, pages
                viewed, and time spent on the site.
              </li>
              <li>
                <strong>Transaction Information:</strong> Information about the
                products and services you rent, hire, or list on our platform.
              </li>
              <li>
                <strong>Location Information:</strong> Geolocation data from
                your device to provide location-based services.
              </li>
            </ul>
          </section>
          ...
          <section style={{ color: 'white' }}>
            ...
            <ul>
              ...
              <li>
                Facilitate transactions and communicate with you about your
                account.
              </li>
              <li>Personalize your experience on our platform.</li>
              <li>
                Monitor and analyze usage and trends to improve our platform.
              </li>
              <li>
          ...
          <section style={{ color: 'white' }}>
            ...
            <ul>
              ...
              <li>
                <strong>Other Users:</strong> When you engage in transactions or
                communication with other users on our platform.
              </li>
              <li>
                <strong>Legal Authorities:</strong> If required by law or to
                protect the rights, property, or safety of ELK, our users, or
                others.
              </li>
            </ul>
          </section>
          ...
          <section style={{ color: 'white' }}>
            ...
            <ul>
              ...
              <li>
                ...
                account and personal information, subject to certain legal
                obligations.
              </li>
            </ul>
          </section>
          ...
          <section style={{ color: 'white' }}>
            ...
            <p>
              ...
              site and updating the effective date at the top. Your continued
          ...
          <section style={{ color: 'white' }} id="contactsinprivacy">
            ...
            <p>
              <strong>Email:</strong> elkcompanyin@gmail.com
            </p>
            <p>
              <strong>Contact No: +91-7012931047</strong>
            </p>
            <p>
              Thank you for trusting ELK with your personal information. We are
              committed to protecting your privacy and ensuring a safe and
