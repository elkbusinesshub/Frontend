...
function AppHeader({isChat}) {
  ...
  return (
    <>
      <Navbar expand="lg" sticky="top" style={{backgroundColor: "#FFDA3F", marginBottom: window.innerWidth <= 768?'0px':"20px"}}>
        <Container>
          ...
          <Navbar.Collapse id="navbar-nav" style={{ zIndex: '1000' }}>
            {
              ...
              <Nav className="ms-auto d-flex flex-row flex-nowrap align-items-center gap-3 justify-content-end w-100">
                {location.pathname !== '/post-ad' && (
                 ...
                 {token1 && ( 
                <>
                  {/* Chat Icon - Hidden on /chat page */}
                  {location.pathname !== '/chat' && ( //
                    <ChatIcon
                      onClick={() => navigate('/chat')} // Navigate to chat
                      fontSize="large"
                      sx={{ color: '#4FBBB4', cursor: 'pointer' }} // Icon styling
                    />
                  )}

                  {/* Wishlist Icon - Hidden on /mywishlist page */}
                  {location.pathname !== '/mywishlist' && ( //
                    <FavoriteBorderIcon
                      onClick={() => navigate('/mywishlist')} // Navigate to wishlist
                      fontSize="large"
                      sx={{ color: '#4FBBB4', cursor: 'pointer' }} // Icon styling
                    />
                  )}
