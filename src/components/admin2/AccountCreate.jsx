...
import { useUploadAdImageMutation } from '../../store/services/common.service'
...
export default function AccountCreateMobile() {
  ...
  const [uploadAdImage] = useUploadAdImageMutation()
                              ...
                              onChange={async (e) => {
                                ...
                                for (const file of newFiles) {
                                  try {
                                    ...
                                    const res =
                                      await uploadAdImage(formData).unwrap()
                                    ...
                                    setFieldValue(`ads.${adIndex}.images`, [
                                      ...existing,
                                      { preview: imageUrl, url: imageUrl },
                                    ])
                                  } catch (err) {
                                    errorMessageToast('Image upload failed')
                                  }
                                }
                              }}
                            />
