                      ...
                      <tr key={ad.id}>
                        ...
                        <td>
                          {ad.ad_price_details?.length > 0
                            ? ad.ad_price_details
                                .map(
                                  (p) => `₹${p.rent_price}/${p.rent_duration}`,
                                )
                                .join(', ')
                            : 'N/A'}
                        </td>
                        ...
                        <td>
                          {ad.ad_images?.length > 0 && (
                            <div className="ad-slider">
                              <img
                                src={
                                  ad.ad_images[sliderIndex[ad.id] || 0]?.image
                                }
                                alt="Ad"
                ...
                ads.map((ad, index) => (
                  <div key={ad.id} className="ad-card">
                    ...
                    <div className="ad-card-body">
                      ...
                      <p>
                        <b>Posted By:</b> {ad.user?.name || 'User'}
                      </p>
                      <p>
                        <b>Date:</b> {dayjs(ad.createdAt).format('MMM D, YYYY')}
                      </p>
                    </div>
                  </div>
                ))
